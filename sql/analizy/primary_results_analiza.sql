--Do wykluczenia z badañ 3 stany: Colodrado, North Dakota, Maine
...
select SBO001207 from county_facts

-- Analiza ze wzgldu na wiek wyborcow.
-- Z analizy wynika, ¿e im ni¿szy udzia³ osob starszych tym wicej glosow uzykiwala partia demokratow
with k1 as
(select
case 
