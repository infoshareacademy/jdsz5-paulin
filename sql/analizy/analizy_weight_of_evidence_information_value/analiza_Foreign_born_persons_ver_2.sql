--Analiza wg udziału imigrantow (creator: Leszek)
...
with a as
         (
             select r.fips,
                    case
                        when f.POP645213 < 5 then '1) niski udzial imigrantow'
                        when f.POP645213 < 10 then '2) sredni udzial imigrantow'
                        when f.POP645213 < 20 then '3) wysoki udzial imigrantow'
                        else '4) bardzo wysoki udzial imigrantow'
                        end as     kategoria,
                    case
