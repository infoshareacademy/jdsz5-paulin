...
with demography as (
select pr.state,pr.county,pr.fips,pr.state_abbreviation as abv,cf.pst045214 as population,(cf.AGE295214/100)*cf.PST045214 as school_age,
...
education as(
select demography.state, demography.county,demography.abv,sum(demography.productive_age+demography.retire_age) as voters,
...
when edu.super_educated/edu.voters >= edu.middle_educated/edu.voters and  edu.super_educated/edu.voters >= edu.primary_non_educated/edu.voters then 'super'
when edu.middle_educated/edu.voters > edu.super_educated/edu.voters and edu.middle_educated/edu.voters > edu.primary_non_educated/edu.voters then 'srenio'
when edu.primary_non_educated/edu.voters > edu.super_educated/edu.voters and edu.primary_non_educated/edu.voters > edu.middle_educated/edu.voters then 'slabo'
end as poziom_edu,
...
select *, sum(iv) over() suma_iv from wsp2
